...
<?php
    ...
    $alert = "";
        ...
        if(isset ($_POST["create"])){
            ...
            $sql = "INSERT INTO `animals`(`name`, `location`, `photo`, `description`, `size`, `age`, `vaccinated`, `breed`, `status`) 
            VALUES ('$name', '$location', '$photo[0]', '$description', '$size', '$age', '$vaccinated', '$breed', '$status')";

            if(mysqli_query($connect, $sql)){
                $alert = "<div class='alert alert-success' role='alert'>
                New record has been created, {$photo[1]}
            </div>";
    ...
    <h2 class="myForm">Add a new animal </h2>
       <form method="POST" enctype= "multipart/form-data">
           ...
           <div class="mb-3">
            ...
            <button name="create" type="submit" class="btn btn-warning text-secondary">Add pet</button>
